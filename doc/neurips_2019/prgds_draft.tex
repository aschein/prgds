...
{\label{fig:matrix_results}\includegraphics[width=0.68\linewidth]{../../results/matrices/new_matrix_results.pdf}}\hfill
% 
\subfigure[Tensor experiments.]
{\label{fig:tensor_results}\includegraphics[width=0.315\linewidth]{../../results/tensors/new_tensor_results.pdf}}\vspace{-0.5em}
