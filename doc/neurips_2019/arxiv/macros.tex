...
\newcommand{\ydk}{y_{\osubs k}}
\newcommand{\ydtk}{y_{\osubs k}^{\mathsmaller{(t)}}}
\newcommand{\mud}{\mu_{\osubs}}
\newcommand{\mudt}{\mu_{\osubs}^{\mathsmaller{(t)}}}
\newcommand{\musdt}{\mu_{\osubs, s}^{\mathsmaller{(t)}}}
...
\newcommand{\thetalam}{\sum_{k_2=1}^K \lambda_{kk_2} \theta_{k_2}^{\mathsmaller{(t{-}1)}}}
\newcommand{\thetapi}{\sum_{k_2=1}^K \pi_{kk_2} \theta_{k_2}^{\mathsmaller{(t{-}1)}}}
...
\newcommand{\hdkt}{h_{\boldsymbol{\cdot} k}^{\mathsmaller{(t)}}}
\newcommand{\hkdt}{h_{k \boldsymbol{\cdot}}^{\mathsmaller{(t)}}}
\newcommand{\hktm}{h_{k}^{\mathsmaller{(t\!-\!1)}}}
\newcommand{\hktp}{h_{k}^{\mathsmaller{(t\!+\!1)}}}
\newcommand{\hdktp}{h_{\boldsymbol{\cdot} k}^{\mathsmaller{(t\!+\!1)}}}
\newcommand{\hkdtp}{h_{k \boldsymbol{\cdot}}^{\mathsmaller{(t\!+\!1)}}}
\newcommand{\hkkt}{h_{kk_2}^{\mathsmaller{(t)}}}
\newcommand{\phimki}{\phi_{k\osub_m}^{\mathsmaller{(m)}}}
